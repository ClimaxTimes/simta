            ...
            <div className="flex-1 flex flex-col">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <motion.button className="relative p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-xl transition-colors" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    ...
                    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
                        ...
                        <motion.div variants={itemVariants} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-4 border-t border-gray-100 flex items-center justify-between">
                                <p className="text-sm text-gray-500">Menampilkan {filteredUsers.length} dari {usersData.length} data</p>
                                <div className="flex items-center gap-2">
            ...
            <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Apakah Anda yakin ingin menonaktifkan user <strong>{selectedUser?.name}</strong>?
